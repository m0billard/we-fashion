<header class="bg-white z-50 top-0 w-full shadow">
  <nav id="main-nav" class="bg-white max-w-5xl mx-auto font-poppins p-6 flex items-center justify-between">
      ...
      <ul id="toggled-menu"
          ...
          <li class="py-4 md:py-0 md:mr-6">
              <a href="#cv" class="text-base uppercase font-semibold w-full hover:text-[#66EB9A]">SOLDES
              </a>
          </li>
          <li class="py-4 md:py-0 md:mr-6">
              <a href="#competences" class="text-base uppercase font-semibold w-full hover:text-[#66EB9A]">HOMME
              </a>
          </li>
          <li class="py-4 md:py-0 md:mr-6">
              <a href="#projets" class="text-base uppercase font-semibold w-full hover:text-[#66EB9A]">FEMME
              </a>
          </li>
      </ul>
  </nav>
